...
def scrape_products(keyword: str, num_products: int) -> pd.DataFrame:
    ...
    try:
        ...
        search_tab = driver.find_element(
            By.XPATH,
        ...
        while len(data) < num_products:
            ...
            # for "Women Clothes for women" and for "Watches for men"
            products = driver.find_elements(
                By.XPATH, "//div[@class='a-section a-spacing-base']"
            )
            logging.info(
                f"Number of products found on page {current_page}: {len(products)}"
            )
            ...
            for product in products:
                ...
                try:
                    brand_name = product.find_element(
                        By.XPATH, ".//h2[@class='a-size-mini s-line-clamp-1']//span"
                    ).text
                except:
                    brand_name = "na"
                ...
                try:
                    product_name = product.find_element(
                        By.XPATH,
                        ".//h2[@class='a-size-base-plus a-spacing-none a-color-base a-text-normal']//span",
                    ).text
                except:
                    product_name = "na"
                ...
                try:
                    ...
                    rating_element = product.find_element(
                        By.XPATH, ".//i[@data-cy='reviews-ratings-slot']//span"
                    )
                ...
                try:
                    rating_count = product.find_element(
                ...
                try:
                    selling_price_element = product.find_element(
                        By.XPATH,
                ...
                try:
                    offer = product.find_element(
                        By.XPATH, ".//div[@class='a-row']//span[contains(text(), '%')]"
                    ).text
                except:
                    offer = "na"
                ...
                if len(data) == num_products:
                    ...
                    return (
                        df  # Immediately exits the entire function if condition is met
                    )
