...
class VectorStoreBuilder:
    ...
    def __init__(self):
        ...
        self.engine = create_engine(self.vectorstore_builder_config.mysql_conn)
    ...
    def load_data(self) -> List[Document]:
        try:
            ...
            df = pd.read_sql_table(
                self.vectorstore_builder_config.cleaned_table, self.engine
            )
    ...
    def create_vector_store(
        ...
        embeddings: HuggingFaceEndpointEmbeddings,
        index_name: str = "rough",
    ) -> PineconeVectorStore:  # ecommerce-chatbot-project
        try:
            ...
            vector_store = PineconeVectorStore.from_documents(
                documents=documents, index_name=index_name, embedding=embeddings
            )
